...
Source0  : http://www.digip.org/jansson/releases/jansson-2.11.tar.gz
Source99 : http://www.digip.org/jansson/releases/jansson-2.11.tar.gz.asc
Summary  : Library for encoding, decoding and manipulating JSON data
Group    : Development/Tools
License  : MIT
Requires: jansson-lib
...
export LANG=C
export SOURCE_DATE_EPOCH=1522192987
...
/usr/lib64/libjansson.so.4.11.0
